...
export default function StepShell({
  ...
  return (
    <div className="min-h-screen ambient-gradient flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full pt-[env(safe-area-inset-top,0px)] pb-[env(safe-area-inset-bottom,0px)]">
        ...
        {/* Content container */}
        <div className="relative z-10 w-full max-w-md mx-auto flex flex-col flex-1 justify-center py-6">
          {/* Header using CSS Grid - prevents overlap */}
          <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 sm:gap-4 mb-6 px-2 sm:px-4">
            {/* Left: Back button */}
            ...
            {currentStep && totalSteps && (
              <div className="flex flex-col items-center justify-center min-w-0">
                <span 
                  className="text-xs sm:text-sm text-gray-500 font-medium mb-1 whitespace-nowrap"
                  style={{ fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}
                >
                  Step {currentStep} of {totalSteps}
                </span>
                <div className="h-0.5 w-full max-w-[180px] sm:max-w-[200px] bg-gray-200 rounded-full overflow-hidden">
                  <motion.div
            ...
            <div className="flex-shrink-0 flex items-center justify-end">
              {phase && (
                <span 
                  className="text-xs text-gray-400 uppercase tracking-wider hidden sm:inline whitespace-nowrap"
                  style={{ fontSize: 'clamp(0.75rem, 2vw, 0.75rem)' }}
                >
                  {phase}
                </span>
              )}
          ...
          {/* Main card panel - consistent spacing from header */}
          <motion.div
